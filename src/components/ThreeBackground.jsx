...
export default function ThreeBackground() {
  ...
  useEffect(() => {
    ...
    // slightly brighter, desaturated ambient to lift shadows without washing out
    ...
    function createLight(color) {
      ...
      // keep multiplier modest to avoid mobile washout
      if (
        sphereMat.color &&
    ...
    // interior box (dimensions match the example)
    const geometry = new THREE.BoxGeometry(30, 30, 30);
    const material = new THREE.MeshPhongMaterial({
      // brighten the interior wall color a touch
      color: 0xb8c0c2,
      shininess: 10,
      specular: 0x111111,
      side: THREE.BackSide,
    ...
    // no stats: removed FPS panel to keep UI clean
